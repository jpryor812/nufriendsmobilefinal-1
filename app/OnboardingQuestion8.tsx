...
const OnboardingPage8: React.FC<OnboardingQuestion1Props> = ({ onSubmit }) => {
  ...
  const handleSend = () => {
    ...
    console.log('Question 8 Answer:', {
      question: 'Is there something new you have always wanted to try? No worries if the answer is no; just type nope!',
      answer: text,
    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <SafeLayout style={styles.appContainer}>
          ...
          />
          <Text style={styles.label}>Question 8/8</Text>
          <View style={[
