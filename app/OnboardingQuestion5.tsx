...
const OnboardingPage5: React.FC<OnboardingQuestion1Props> = ({ onSubmit }) => {
  ...
  const handleSend = () => {
    ...
    router.push('/OnboardingQuestion6'); // Replace with your actual next route
  };
    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <SafeLayout style={styles.appContainer}>
          ...
          />
          <Text style={styles.label}>Question 5/8</Text>
          <View style={[
