...
const OnboardingAvatarCustomization = ({ unlockedItems = [] }: Props) => {  // Remove userId from Props
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.showroomContainer}>
        <Image
          ...
          resizeMode="contain"
        />
<Continue onPress={handleContinue} isLoading={isSaving} />      
</View>
...
export default OnboardingAvatarCustomization;