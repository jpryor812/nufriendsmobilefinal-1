...
const OnboardingPage4: React.FC<OnboardingQuestion1Props> = ({ onSubmit }) => {
  ...
  const handleSend = () => {
    ...
    console.log('Question 4 Answer:', {
      question: 'Do you have any siblings or pets? If so, describe them!',
      answer: text,
    ...
    router.push('/OnboardingQuestion5'); // Replace with your actual next route
  };
    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <SafeAreaView style={styles.appContainer}>
          ...
          <BigYuOnboarding 
            text={`Question 4: \nDo you have any siblings or pets? If so, describe them!`} 
          />
          <Text style={styles.label}>Question 4/8</Text>
          <View style={[
