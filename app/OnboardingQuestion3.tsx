...
const OnboardingQuestion3: React.FC<OnboardingQuestion3Props> = ({ onSubmit }) => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      await updateOnboardingResponse('relationships', text);

    // Log the answer
    console.log('Question 3 Answer:', {
      question: "Tell us about the important relationships in your life! This could be family, pets, or close friends. If you can’t think of any, that’s ok! We will help you find them.",
      answer: text,
    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <SafeLayout style={styles.appContainer}>
          ...
          <BigYuOnboarding 
            text={"Question 3: \nTell us about the important relationships in your life! This could be family, pets, or close friends. If you can’t think of any, that’s ok! We will help you find them."} 
          />
          <View style={styles.questionHeader}>
          <View style={styles.questionCounterContainer}>
          <Text style={styles.label}>Question 3/7</Text>
          </View>
